    ...
    <section id="about" className="about">
      <div className="container about-grid">
        ...
        <motion.div className="about-content" initial={{opacity:0, x:40}} animate={{opacity:1,x:0}} transition={{duration:0.8}}>
          ...
          <p><strong>JeetWeb </strong>, Website Developer of Jeetweb, specializes in creating high-performance, modern, and fully optimized websites that help businesses scale faster and build a powerful online presence.</p>
          <div className="stats">
            <div><strong>520+</strong><span>Happy Clients</span></div>
            <div><strong>₹5lakh+</strong><span>Revenue Generated</span></div>
